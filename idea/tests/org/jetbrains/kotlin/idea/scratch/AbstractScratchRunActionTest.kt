...
abstract class AbstractScratchRunActionTest : FileEditorManagerTestCase() {
    ...
    fun doScratchPreviewOutputReplTest(fileName: String) {
        doPreviewEditorOutputTest(fileName = fileName, isRepl = false)
    }
    ...
    fun doInlayOutputTest(fileName: String, isRepl: Boolean, isWorksheet: Boolean) {
    ...
    private fun doPreviewEditorOutputTest(fileName: String, isRepl: Boolean) {
    ...
    private fun getPreviewTextWithFoldings(): String {
        ...
        return CodeInsightTestFixtureImpl.getFoldingData(previewEditor, /*withCollapseData=*/false)
    }
