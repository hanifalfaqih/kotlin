...
public class ScratchRunActionTestGenerated extends AbstractScratchRunActionTest {
    ...
    public static class ScratchRightPanelOutput extends AbstractScratchRunActionTest {
        ...
        @TestMetadata("test1.kts")
        public void testTest1() throws Exception {
            runTest("idea/testData/scratch/rightPanelOutput/test1.kts");
        }

        @TestMetadata("test2.kts")
        public void testTest2() throws Exception {
            runTest("idea/testData/scratch/rightPanelOutput/test2.kts");
        }

        @TestMetadata("test3.kts")
        public void testTest3() throws Exception {
            runTest("idea/testData/scratch/rightPanelOutput/test3.kts");
        }

        @TestMetadata("test4.kts")
        public void testTest4() throws Exception {
            runTest("idea/testData/scratch/rightPanelOutput/test4.kts");
        }
    }
}
